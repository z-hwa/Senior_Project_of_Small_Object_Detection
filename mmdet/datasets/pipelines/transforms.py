...
@PIPELINES.register_module()
class RandomCenterCropPadWithHardNegative(RandomCenterCropPad):

    def __init__(self, crop_size=None, ratios=(0.9, 1.0, 1.1), border=128, mean=None, std=None, to_rgb=None,
                 test_mode=False, test_pad_mode=('logical_or', 127), test_pad_add_pix=0, bbox_clip_border=True,
                 hard_negative_ratio=0.25):

        super().__init__(crop_size, ratios, border, mean, std, to_rgb, test_mode, test_pad_mode, test_pad_add_pix,
                         bbox_clip_border)

        assert 0 < hard_negative_ratio <= 1, 'hard_negative_ratio should be in the range of (0, 1]'
