...
class AdaptiveIoUAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None, epoch=None, epochs=None, bbox_target=None):
        """Assign gt to bboxes.
        ...
        assign_result = self.assign_wrt_overlaps(overlaps, bboxes, gt_bboxes, gt_labels, epoch, epochs, bbox_target)
        if assign_on_cpu:
    ...
    def assign_wrt_overlaps(self, overlaps, bboxes, gt_bboxes, gt_labels=None, epoch=None, epochs=None, bbox_target=None):
