...
class StandaradDeviationIoUAssigner(BaseAssigner):
    ...
    def __init__(self,
        ...
        self.pos_lower_standard = pos_lower_standard
        self.neg_upper_standard = neg_upper_standard
    ...
    def assign_wrt_overlaps(self, overlaps, gt_labels=None):
        ...
        # 計算平均值以及標準差
        mean_values = torch.mean(overlaps, dim=1)
        std_values = torch.std(overlaps, dim=1)
