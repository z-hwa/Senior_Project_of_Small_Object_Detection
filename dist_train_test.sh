...
python tools/dist_test.py work_dirs/cascade_mask_rcnn_swin_finetune_rfla_4stage/cascade_mask_rcnn_swin_finetune_rfla_4stage.py work_dirs/cascade_mask_rcnn_swin_finetune_rfla_4stage/epoch_104.pth $GPU_NUM --out result_val.pkl
...
python tools/analysis_tools/eval_metric.py work_dirs/cascade_mask_rcnn_swin_finetune_rfla_4stage/cascade_mask_rcnn_swin_finetune_rfla_4stage.py result_val.pkl --eval bbox